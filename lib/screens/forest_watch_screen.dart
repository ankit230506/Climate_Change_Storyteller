...
import '../services/forest_watch_service.dart';
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Row(children: [
            ...
            Text('Forest layer loaded on LG!'),
          ]),
