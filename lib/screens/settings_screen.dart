...
class _ApiSetupScreenState extends State<ApiSetupScreen> {
  ...
  bool _geminiSet = false, _obscure = true;
    ...
    return Scaffold(
      ...
      body: SafeArea(child: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          Text('Gemini key for narration · Flutter TTS for voice',
          ...
          Container(
            ...
            child: Column(children: [
              ...
              TextFormField(controller: _geminiCtrl, obscureText: _obscure,
                onChanged: (v) => setState(() => _geminiSet = v.length > 8),
                style: const TextStyle(fontFamily: 'monospace',
                    fontSize: 13, color: AppColors.textPrimary),
                decoration: InputDecoration(hintText: 'AIza••••••••••••',
                  suffixIcon: IconButton(
