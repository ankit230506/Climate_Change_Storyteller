...
class _DataInsightsScreenState extends State<DataInsightsScreen> {
  ...
  Widget _buildChart(int index) => switch (index) {
    0 => const _TemperatureChart(key: ValueKey('temp')),
    1 => const _IceExtentChart(key: ValueKey('ice')),
    2 => const _SeaLevelChart(key: ValueKey('sea')),
  ...
  Widget _buildEraReference() {
    ...
    final divisor = _selectedChart == 1 ? 1.0 : 1.0;
            ...
            child: LineChart(LineChartData(
              gridData: FlGridData(
                ...
                getDrawingHorizontalLine: (_) =>
                    const FlLine(color: Color(0xFF1C2035), strokeWidth: 1),
              ),
              ...
              lineBarsData: [LineChartBarData(
                ...
                belowBarData: BarAreaData(
                  ...
                  gradient: LinearGradient(
                    ...
                    colors: [AppColors.heat.withValues(alpha: 0.3),
                             AppColors.heat.withValues(alpha: 0.0)],
                  ),
                ),
              )],
            ...
            child: LineChart(LineChartData(
              ...
              lineBarsData: [LineChartBarData(
                ...
                belowBarData: BarAreaData(
                  ...
                  gradient: LinearGradient(
                    begin: Alignment.topCenter, end: Alignment.bottomCenter,
                    colors: [AppColors.seaLevel.withValues(alpha: 0.3),
                             AppColors.seaLevel.withValues(alpha: 0.0)],
                  ),
                ),
              )],
              lineTouchData: LineTouchData(
