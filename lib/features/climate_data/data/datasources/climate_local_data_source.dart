...
abstract class ClimateLocalDataSource {
  double getInterpolatedTemperature(int year);
  double getInterpolatedSeaLevel(int year);
  double getInterpolatedIceExtent(int year);
  double getInterpolatedForestLoss(int year);
  IpccRegionData? getIpccRegionData(String regionId);
}

class ClimateLocalDataSourceImpl implements ClimateLocalDataSource {
  @override
  ...
  @override
  IpccRegionData? getIpccRegionData(String regionId) => getRegionData(regionId);
