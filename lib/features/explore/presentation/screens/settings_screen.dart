...
import 'package:climate_storyteller/features/explore/presentation/screens/kml_cache_screen.dart';
import 'package:climate_storyteller/features/explore/presentation/screens/api_setup_screen.dart';
  ...
  Future<void> _connect() async {
    ...
    try {
      ...
      if (ok) {
        ...
        final latency = DI.lgRepository.state.latencyMs;
